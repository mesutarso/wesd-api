...
export interface ApiHouseholdHousehold extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    baseline_data: Schema.Attribute.Component<
    ...
    Ics_surveys: Schema.Attribute.Component<
      ...
      false
    >;
    investigator_activities: Schema.Attribute.Component<
      'composants.ics-investigators-survey',
      true
    >;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_identity: Schema.Attribute.Component<'composants.identity', false>;
    users_permissions_user: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    voa: Schema.Attribute.Relation<'manyToOne', 'api::voa.voa'>;
  };
}

export interface ApiVoaVoa extends Struct.CollectionTypeSchema {
  collectionName: 'voas';
  info: {
    description: '';
    displayName: 'voa';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    households: Schema.Attribute.Relation<
      'oneToMany',
      'api::household.household'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::voa.voa'> &
      Schema.Attribute.Private;
